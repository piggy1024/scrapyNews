...
class Scrap_News(object):
    ...
    def get_page(self):
        ...
        while index > 0:
            response = requests.get(
                "http://economy.southcn.com/e/node_321237_" + str(
                    index) + ".htm",
    ...
    def get_southnetwork_url(self):
        ...
        # 保存所有可分析dom获取url的网址
        url_lists_economy = ["http://economy.southcn.com/e/node_321237.htm"]

        for i in range(2, self.page):  # 50页是写死的
            url_lists_economy.append("http://economy.southcn.com/e/node_321237_" + str(i) + ".htm")
        self.origin_url = url_lists_economy
    ...
    def get_south_data(self):
        ...
        # 放之前爬过的url
        result = []  # 从文件中读取得到
        file_read = open('south_economy_url.txt', 'r')
        ...
        with open('south_economy_url.txt', "a", encoding='utf-8') as file:
            file.write(list_str + '\n')
        file.close()

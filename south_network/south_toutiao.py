...
class Scrap_News(object):
    ...
    def get_page(self):
        ...
        while index > 0:
            response = requests.get(
                "http://www.southcn.com/pc2018/tt/node_384372_" + str(
                    index) + ".htm",
    ...
    def get_southnetwork_url(self):
        ...
        # 保存所有可分析dom获取url的网址
        url_lists = ["http://www.southcn.com/pc2018/tt/node_384372.htm"]

        # 一共只有5页
        for i in range(2, self.page):
            url_lists.append("http://www.southcn.com/pc2018/tt/node_384372_" + str(i) + ".htm")
    ...
    def get_south_data(self):
        ...
        for url in self.origin_url:
            ...
            contents_urls_lists = html.xpath("//div[@id='list_content']//ul//li//a/@href")
        ...
        # 放之前爬过的url
        result = []  # 从文件中读取得到
        file_read = open('south_toutiao_url.txt', 'r')
        ...
        with open('south_toutiao_url.txt', "a", encoding='utf-8') as file:
            file.write(list_str + '\n')
        file.close()

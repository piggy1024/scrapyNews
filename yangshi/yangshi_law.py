...
class Scrap_News(object):
    ...
    def get_page(self):
        ...
        while index > 0:
            response = requests.get(
                "https://news.cctv.com/2019/07/gaiban/cmsdatainterface/page/law_" + str(
                    index) + ".jsonp?cb=t&cb=law",
    ...
    def get_yangshi_urls(self):
        ...
        for index in range(1, self.page):  # (1,8)
            url_lists.append(
                "https://news.cctv.com/2019/07/gaiban/cmsdatainterface/page/law_" + str(
                    index) + ".jsonp?cb=t&cb=law")
        ...
        # 放之前爬过的url
        result = []  # 从文件中读取得到
        file_read = open('yangshi_law_url.txt', 'r')
        ...
        with open('yangshi_law_url.txt', "a", encoding='utf-8') as file:
            file.write(list_str + '\n')
        file.close()
    ...
    # 获取央视新闻网-法治的具体文章内容函数
    def get_yangshi_law_news_data(self):
        url_law = self.origin_url
        for url in url_law:
            try:
    ...
    def start(self):
        ...
        self.get_yangshi_law_news_data()

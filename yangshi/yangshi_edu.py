...
class Scrap_News(object):
    ...
    def get_page(self):
        ...
        while index > 0:
            response = requests.get(
                "https://news.cctv.com/2019/07/gaiban/cmsdatainterface/page/edu_" + str(
                    index) + ".jsonp?cb=t&cb=edu",
    ...
    def get_yangshi_urls(self):
        ...
        # 放之前爬过的url
        result = []  # 从文件中读取得到
        file_read = open('yangshi_edu_url.txt', 'r')
        ...
        with open('yangshi_edu_url.txt', "a", encoding='utf-8') as file:
            file.write(list_str + '\n')
        file.close()
    ...
    # 获取央视新闻网-教育的具体文章内容函数
    def get_yangshi_edu_news_data(self):
        url_edu = self.origin_url
        for url in url_edu:
            try:
    ...
    def start(self):
        ...
        self.get_yangshi_edu_news_data()

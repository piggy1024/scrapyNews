...
class Scrap_News(object):
    ...
    def get_page(self):
        ...
        while index > 0:
            response = requests.get(
                "https://news.cctv.com/2019/07/gaiban/cmsdatainterface/page/society_" + str(
                    index) + ".jsonp?cb=t&cb=society",
    ...
    def get_yangshi_urls(self):
        ...
        # 放之前爬过的url
        result = []  # 从文件中读取得到
        file_read = open('yangshi_society_url.txt', 'r')
        ...
        with open('yangshi_society_url.txt', "a", encoding='utf-8') as file:
            file.write(list_str + '\n')
        file.close()
    ...
    # 获取央视新闻网-社会的具体文章内容函数
    def get_yangshi_society_news_data(self):
        url_society = self.origin_url
        for url in url_society:
            try:
    ...
    def start(self):
        ...
        self.get_yangshi_society_news_data()
